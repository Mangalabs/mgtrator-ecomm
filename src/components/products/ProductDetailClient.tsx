...
export const ProductDetailClient = ({ slug }: ProductDetailClientProps) => {
  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
         ...
         <p className="text-gray-600">O produto &quot;{slug}&quot; não foi localizado em nosso catálogo.</p>
         <Link href="/produtos" className="mt-4 text-blue-600 hover:underline">Voltar para loja</Link>
      </div>
    )
  }
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Sim! Todas as peças possuem garantia de fábrica de no mínimo 90 dias contra defeitos de fabricação. Peças específicas podem ter garantia estendida.'
    },
    {
      question: 'Como sei se a peça é compatível com meu equipamento?',
      answer: 'Nossa equipe técnica está disponível para confirmar compatibilidade. Entre em contato via WhatsApp com o modelo e série do seu equipamento que faremos a verificação.'
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            {product.compatibility && (
              <div className="bg-gradient-to-r from-[var(--secondary)]/10 via-[var(--secondary)]/5 to-transparent border-l-4 border-[var(--secondary)] rounded-xl p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-black text-[var(--neutral-900)] mb-1">Compatibilidade</div>
                    <div className="text-[var(--neutral-700)] text-sm leading-relaxed">{product.compatibility}</div>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="bg-gradient-to-br from-slate-50 to-white border border-[var(--neutral-200)] rounded-xl p-4">
              <div className="grid grid-cols-2 gap-3 text-xs">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[var(--neutral-700)]">Suporte técnico</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="bg-gradient-to-br from-slate-50 to-white border-2 border-[var(--neutral-200)] rounded-2xl p-6 sticky top-24 shadow-lg">
                ...
                <dl className="space-y-3">
                  <div className="bg-white rounded-xl p-3 border border-[var(--neutral-200)] shadow-sm">
                    <dt className="text-xs text-[var(--neutral-600)] uppercase tracking-wider font-bold mb-1">Marca</dt>
                    <dd className="font-black text-[var(--primary)]">{product.brandName}</dd>
                  </div>
                  <div className="bg-white rounded-xl p-3 border border-[var(--neutral-200)] shadow-sm">
                    <dt className="text-xs text-[var(--neutral-600)] uppercase tracking-wider font-bold mb-1">Código</dt>
                    <dd className="font-black text-[var(--primary)]">{product.sku || product.partNumber || product.code}</dd>
                  </div>
                  <div className="bg-white rounded-xl p-3 border border-[var(--neutral-200)] shadow-sm">
                    <dt className="text-xs text-[var(--neutral-600)] uppercase tracking-wider font-bold mb-1">Categoria</dt>
                    <dd className="font-black text-[var(--primary)]">{product.categoryName}</dd>
                  </div>
                </dl>
              </div>
            </div>
        ...
        <div className="mb-16 max-w-3xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-[var(--neutral-600)]">Tudo o que você precisa saber sobre este produto</p>
          </div>
          <div className="space-y-3">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white border-2 border-[var(--neutral-200)] rounded-xl overflow-hidden hover:border-[var(--primary)]/30 transition-colors">
                <button
                  onClick={() => setExpandedFaq(expandedFaq === index ? null : index)}
                  className="w-full px-6 py-4 flex items-center justify-between gap-4 text-left"
                >
                  <span className="font-bold text-[var(--neutral-900)]">{faq.question}</span>
                  {expandedFaq === index ? (
                ...
                {expandedFaq === index && (
                  <div className="px-6 pb-4">
                    <p className="text-[var(--neutral-700)] leading-relaxed">{faq.answer}</p>
                  </div>
                )}
              </div>
            ))}
        ...
        {relatedProducts.length > 0 && (
          <section className="mb-12">
            <div className="text-center mb-8">
              ...
              <p className="text-[var(--neutral-600)]">Outras peças que podem te interessar</p>
            </div>
