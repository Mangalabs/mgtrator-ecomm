        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="mb-12">
            <div className="relative max-w-4xl mx-auto">
              <div className="relative">
                <Search className="absolute left-6 top-1/2 -translate-y-1/2 w-6 h-6 text-[var(--primary)]" aria-hidden="true" />
                <input
                  type="text"
                  value={searchQuery}
            ...
            {searchQuery && (
              <div className="text-center mt-5">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[var(--primary)] to-[#1a2d5e] text-white px-5 py-2.5 rounded-2xl font-bold shadow-lg">
                  ...
                  <span>{filteredProducts.length} resultado(s) encontrado(s) para &quot;{searchQuery}&quot;</span>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="lg:w-72 flex-shrink-0">
              ...
              <div className={`bg-white/80 backdrop-blur-sm border-2 border-[var(--neutral-200)] rounded-2xl p-6 shadow-xl ${showFilters || 'hidden lg:block'}`}>
                ...
                <div className="mb-6">
                  <h4 className="text-sm font-bold mb-3 text-[var(--neutral-700)] uppercase tracking-wide">Categoria</h4>
                  <select
                ...
                <div className="mb-6">
                  <h4 className="text-sm font-bold mb-3 text-[var(--neutral-700)] uppercase tracking-wide">Marca</h4>
                  <select
                    value={selectedBrand}
                ...
                <div className="mb-6">
                  <h4 className="text-sm font-bold mb-3 text-[var(--neutral-700)] uppercase tracking-wide">Ordenar Por</h4>
                  <select
                    value={sortBy}
            ...
            <div className="flex-1">
              ...
              {filteredProducts.length === 0 && (
                <div className="text-center py-20">
                  <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-[var(--neutral-100)] to-[var(--neutral-200)] rounded-3xl mb-6">
                    <Search className="w-12 h-12 text-[var(--neutral-400)]" aria-hidden="true" />
                  </div>
                  <h3 className="font-black text-2xl mb-3 text-[var(--neutral-900)]">Nenhum produto encontrado</h3>
                  <p className="text-[var(--neutral-600)] text-lg mb-8">Tente ajustar os filtros ou entre em contato conosco</p>
                  <button
                    onClick={() => {
                      setSelectedCategory('all')
                      setSelectedBrand('all')
              ...
              {filteredProducts.length > 0 && (
                <div className="flex justify-center gap-2 mt-16">
                  <button className="px-5 py-3 border-2 border-[var(--neutral-200)] rounded-xl hover:bg-white hover:border-[var(--primary)] hover:text-[var(--primary)] transition-all font-semibold bg-white/60 backdrop-blur-sm">
                    Anterior
                  </button>
                  <button className="px-5 py-3 bg-gradient-to-r from-[var(--primary)] to-[#1a2d5e] text-white rounded-xl font-bold shadow-lg">
                    1
                  </button>
                  <button className="px-5 py-3 border-2 border-[var(--neutral-200)] rounded-xl hover:bg-white hover:border-[var(--primary)] hover:text-[var(--primary)] transition-all font-semibold bg-white/60 backdrop-blur-sm">
                    2
