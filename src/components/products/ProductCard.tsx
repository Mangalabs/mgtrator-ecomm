      ...
      <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-50/50 p-8">
        ...
        >
          {image ? (
            ...
            <div className="w-full h-full bg-gray-100 flex items-center justify-center text-gray-400 text-xs">Sem Imagem</div>
          )}
        </Link>
        ...
        <div className="absolute top-4 left-4 right-4 flex items-start justify-between gap-2 pointer-events-none">
          ...
          {productDetails.hasDiscount && (
            ...
            >
              <span className="text-xs font-black">-{productDetails.discountPercent}%</span>
            </motion.div>
          )}
        </div>
