                ...
                <div className='grid lg:grid-cols-2 gap-0'>
                  <div className='relative'>
                    <div className='absolute top-6 left-6 z-10'>
                      <div className='inline-flex items-center gap-2 bg-white/95 backdrop-blur-xl border-2 border-white/60 px-4 py-2 rounded-2xl shadow-xl'>
                        ...
                        <span className='font-black text-[var(--primary)] uppercase tracking-wide'>
                          {' '}
                          {store.address.city}
                        </span>
                      </div>
                  ...
                  <div className='p-8 lg:p-10 flex flex-col'>
                    ...
                    <div className='space-y-4 mb-8'>
                      <div className='flex items-start gap-4 p-4 bg-slate-50 rounded-2xl border border-[var(--neutral-200)] hover:border-[var(--primary)]/30 transition-colors'>
                        ...
                        <div className='flex-1'>
                          <div className='font-bold text-sm text-[var(--neutral-900)] mb-1'>
                            Endereço
                          </div>
                    ...
                    {store.features && store.features.length > 0 && (
                      <div className='mb-8'>
                        <div className='font-bold text-sm text-[var(--neutral-900)] mb-3 uppercase tracking-wide'>
                        ...
                        <div className='grid grid-cols-2 gap-3'>
                          {store.features.map((feature, idx) => (
                            <div
                              key={idx}
                              className='flex items-center gap-2 text-sm text-[var(--neutral-700)] bg-white rounded-xl px-3 py-2 border border-[var(--neutral-200)]'>
        ...
        <div className='relative max-w-7xl mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-[var(--neutral-600)] max-w-3xl mx-auto'>
              Experiência completa com atendimento especializado e toda a
              estrutura para melhor atendê-lo
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16'>
            <motion.div
              ...
              <p className='text-sm text-[var(--neutral-700)] leading-relaxed'>
                Equipe especializada para auxiliar na escolha da{' '}
                <strong>peça correta</strong> para seu equipamento
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              <p className='text-sm text-[var(--neutral-700)] leading-relaxed'>
                Peças em estoque para <strong>retirada na hora</strong>. Sem
            ...
            <motion.div
              ...
              <p className='text-sm text-[var(--neutral-700)] leading-relaxed'>
                <strong>Amplo estacionamento gratuito</strong> em todas as
            ...
            <motion.div
              ...
              <p className='text-sm text-[var(--neutral-700)] leading-relaxed'>
                Todas as peças com <strong>certificado e garantia</strong>.
                Compra segura e procedente
              </p>
            </motion.div>
          </div>
            ...
            <div className='flex flex-col lg:flex-row items-center gap-8'>
              <div className='flex-1'>
                ...
                <p className='text-lg text-[var(--neutral-700)] leading-relaxed mb-6'>
                  Em nossas lojas físicas você tem acesso a todo nosso estoque,
                  pode visualizar as peças pessoalmente e contar com a
                  orientação de profissionais com{' '}
                  <strong>mais de 25 anos de experiência</strong> no segmento.
                </p>
                <div className='grid sm:grid-cols-3 gap-4'>
                  <div className='flex items-center gap-3 bg-white rounded-2xl p-4 border border-[var(--neutral-200)]'>
                    ...
                    <div>
                      <div className='font-black text-lg text-[var(--neutral-900)]'>
                        +10k
                      </div>
                      <div className='text-xs text-[var(--neutral-600)] font-semibold'>
                        Clientes
                      </div>
                    </div>
                  </div>
      ...
      <section className='py-20 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 relative overflow-hidden'>
        ...
        <div className='relative max-w-7xl mx-auto px-4'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-[var(--neutral-600)] max-w-3xl mx-auto'>
              Atendemos você também pelos nossos canais digitais com a mesma
          ...
          <div className='grid lg:grid-cols-2 gap-8'>
            <motion.div
              ...
              <div className='relative z-10'>
                ...
                <h3 className='font-black text-3xl mb-4'>WhatsApp Direto</h3>

                <p className='text-lg text-white/90 mb-8 leading-relaxed'>
                  Consulte disponibilidade, tire dúvidas e faça seu pedido
                  diretamente pelo WhatsApp com nossa equipe especializada.
                </p>
              ...
              <div className='relative z-10'>
                <div className='w-20 h-20 bg-white rounded-3xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 transition-transform duration-300'>
                  <svg viewBox='0 0 48 48' className='w-12 h-12'>
                    <path
                      fill='#2D3277'
                      d='M37.8 15.4c-3.1-3.1-8.1-3.1-11.2 0L24 18.1l-2.6-2.7c-3.1-3.1-8.1-3.1-11.2 0-3.1 3.1-3.1 8.1 0 11.2L24 40.4l13.8-13.8c3.1-3.2 3.1-8.2 0-11.2z'
                    />
                  </svg>
                </div>
                ...
                <p className='text-lg text-[#2D3277]/80 mb-8 leading-relaxed'>
                  Nossa <strong>loja oficial verificada</strong> na maior
                  plataforma de e-commerce da América Latina. Compra 100%
                  protegida.
                </p>
