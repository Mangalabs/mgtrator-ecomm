  ...
  const steps = [
    {
      ...
      description:
        'Navegue pelo catálogo, use a busca ou filtros por marca/categoria. Cada produto mostra compatibilidade, especificações técnicas e disponibilidade em estoque.',
      gradient: 'from-blue-600 to-blue-700',
      tips: [
        'Use a busca por código da peça',
        'Filtre por marca do equipamento',
        'Consulte compatibilidade na descrição',
      ],
    },
    {
      number: '02',
      ...
      description:
        'Selecione a quantidade desejada e clique em "Adicionar ao Carrinho". Você pode continuar comprando ou ir direto para o checkout. Seu carrinho fica salvo automaticamente.',
      gradient: 'from-emerald-600 to-emerald-700',
      tips: [
        'Revise a quantidade antes de adicionar',
        'Consulte o resumo do carrinho',
    ...
    },
    {
      ...
      description:
        'Informe seus dados (nome, CPF/CNPJ, endereço, telefone) e escolha a forma de pagamento: PIX (5% desconto), Cartão (até 12x), Boleto (3% desconto) ou Faturamento PJ.',
      gradient: 'from-amber-600 to-amber-700',
      tips: [
        'PIX tem aprovação instantânea',
        'Cartão: parcele em até 12x',
        'Empresas: faturamento 30/60 dias',
      ],
    },
    {
      number: '04',
      ...
      description:
        'Após confirmação do pagamento, você recebe o código de rastreamento por e-mail/SMS. Acompanhe a entrega em tempo real ou retire em nossa loja em Contagem/Betim.',
      gradient: 'from-purple-600 to-purple-700',
      tips: [
        'Rastreie pelo site da transportadora',
        'Retirada em até 24h (estoque)',
        'Frete grátis acima de R$ 1.500 (BH)',
      ],
    },
  ]
  ...
  const channels = [
    {
      ...
      title: 'Site',
      description:
        'Navegue pelo catálogo completo, compare produtos e finalize sua compra com segurança',
      link: '/produtos',
    ...
    },
    {
      ...
      title: 'WhatsApp',
      description:
        'Atendimento personalizado, tire dúvidas técnicas e faça pedidos direto pelo chat',
      link: 'https://tintim.link/whatsapp/d6ae85fb-b33f-4b08-b29b-e9b0ee72942a/135f8540-2a5d-4573-b52f-338b7b4d4d39',
      linkText: '(85) 9191-1540',
    },
    {
      icon: Store,
      title: 'Loja Física',
      description:
        'Visite nossas unidades em Contagem ou Betim para atendimento presencial',
      link: '/lojas',
  ...
  const faqs = [
    {
      ...
      answer:
        'Cada produto lista os modelos compatíveis. Nossa equipe técnica também auxilia via WhatsApp. Informe modelo, série e ano do equipamento ou envie foto da placa de identificação.',
    },
    {
      question: 'Posso parcelar sem juros?',
      answer:
        'Sim! Parcelamento em até 12x no cartão de crédito para compras acima de R$ 300. PIX e Boleto têm desconto à vista. Empresas têm condições especiais de faturamento.',
    },
    {
      question: 'Qual o prazo de entrega?',
      answer:
        'Pronta Entrega: 2-5 dias úteis (MG). Sob Encomenda: 7-15 dias. Importados: 20-30 dias. O prazo exato é calculado no checkout após informar o CEP.',
    },
    {
      question: 'Posso retirar na loja?',
      answer:
        'Sim! Escolha "Retirar em Loja" no checkout. Seu pedido fica disponível em até 24h após confirmação do pagamento (produtos em estoque). Você recebe notificação quando estiver pronto.',
    },
  ]
        ...
        <div className='relative max-w-7xl mx-auto px-4 py-20'>
          <motion.div
            ...
            <p className='text-xl text-blue-100 max-w-3xl mx-auto mb-8'>
              Comprar peças para maquinas pesadas e máquinas pesadas nunca foi
              tão fácil e seguro
            </p>
            ...
            {steps.map((step, index) => (
              <motion.div
                ...
                <div className='bg-white rounded-3xl border-2 border-gray-200 p-8 hover:border-[var(--primary)]/50 hover:shadow-2xl transition-all duration-500'>
                  ...
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${step.gradient} rounded-2xl flex items-center justify-center mb-6 ml-auto group-hover:scale-110 transition-transform shadow-xl`}>
                  ...
                  <div className='space-y-2'>
                    {step.tips.map((tip, tipIndex) => (
                      <div
                        key={tipIndex}
                        className='flex items-start gap-2 text-sm text-[var(--neutral-600)]'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
            {paymentMethods.map((method, index) => (
              <motion.div
                ...
                <div
                  className={`absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-${method.color}-600 to-${method.color}-700 text-white px-4 py-1.5 rounded-full text-xs font-black shadow-lg`}>
                  {method.badge}
                </div>

                <div className='text-6xl mb-4 group-hover:scale-110 transition-transform items-center justify-center'>
                  <method.icon />
                </div>
                <h3 className='font-black text-xl text-[var(--neutral-900)] mb-2'>
                  {method.title}
                </h3>
          ...
          <div className='space-y-4'>
            {faqs.map((faq, index) => (
              <motion.div
                ...
                <p className='text-[var(--neutral-700)] leading-relaxed ml-7'>
                  {faq.answer}
                </p>
              </motion.div>
            ))}
        ...
        <div className='max-w-4xl mx-auto px-4 text-center'>
          <motion.div
            ...
            <p className='text-xl text-blue-100 mb-10 max-w-2xl mx-auto'>
              Navegue pelo catálogo e encontre as peças certas para seu
              equipamento
            </p>
            <div className='flex flex-wrap justify-center gap-4'>
              <Link
