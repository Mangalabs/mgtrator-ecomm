...
import { Check, Sparkles, ArrowRight, Shield, Award, Truck, Package, Star } from 'lucide-react'
      ...
      <section className="relative bg-gradient-to-br from-[var(--primary)] via-[#1a2d5e] to-[var(--primary)] text-white overflow-hidden" style={{ height: '320px' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 h-full flex items-center relative z-10">
          <div>
            ...
            <h1 className="text-white mt-6 mb-4">Marcas Atendidas</h1>
            <p className="text-xl text-blue-100 max-w-2xl">
              Trabalhamos com as principais marcas de tratores e máquinas pesadas do mundo
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[var(--neutral-600)] max-w-3xl mx-auto">
              Trabalhamos exclusivamente com fabricantes líderes mundiais, garantindo qualidade e performance
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <p className="text-[var(--neutral-700)] leading-relaxed mb-6">
                Peças <strong>originais de fábrica</strong> com certificado de autenticidade. Garantia total de procedência e qualidade.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-sm text-[var(--neutral-600)]">
                  <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full mt-1.5 flex-shrink-0" />
                  <span>Garantia de <strong>12 meses</strong> em peças genuínas</span>
                </li>
                <li className="flex items-start gap-2 text-sm text-[var(--neutral-600)]">
                  <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full mt-1.5 flex-shrink-0" />
            ...
            >
              ...
              <p className="text-[var(--neutral-700)] leading-relaxed mb-6">
                <strong>Mais de 25 anos</strong> atendendo o segmento de máquinas pesadas com equipe especializada.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-sm text-[var(--neutral-600)]">
            ...
            >
              ...
              <p className="text-[var(--neutral-700)] leading-relaxed mb-6">
                <strong>Pronta entrega</strong> das peças mais procuradas de todas as marcas que atendemos.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start gap-2 text-sm text-[var(--neutral-600)]">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8">
              <div className="flex-1">
                ...
                <p className="text-lg text-[var(--neutral-700)] leading-relaxed mb-6">
                  Cada marca possui características únicas. Nossa equipe ajuda você a encontrar a peça ideal 
                  para seu equipamento, considerando modelo, ano e aplicação específica.
                </p>
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="flex items-center gap-3 bg-white rounded-2xl p-4 border border-[var(--neutral-200)]">
                    ...
                    <span className="font-bold text-sm text-[var(--neutral-900)]">Motores e Transmissões</span>
                  </div>
                  <div className="flex items-center gap-3 bg-white rounded-2xl p-4 border border-[var(--neutral-200)]">
                    <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Check className="w-5 h-5 text-white" />
                    </div>
                    <span className="font-bold text-sm text-[var(--neutral-900)]">Sistemas Hidráulicos</span>
                  </div>
                  <div className="flex items-center gap-3 bg-white rounded-2xl p-4 border border-[var(--neutral-200)]">
                    <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Check className="w-5 h-5 text-white" />
                    </div>
                    <span className="font-bold text-sm text-[var(--neutral-900)]">Filtros e Manutenção</span>
                  </div>
                  <div className="flex items-center gap-3 bg-white rounded-2xl p-4 border border-[var(--neutral-200)]">
                    <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center flex-shrink-0">
                      <Check className="w-5 h-5 text-white" />
                    </div>
                    <span className="font-bold text-sm text-[var(--neutral-900)]">Componentes Elétricos</span>
                  </div>
                </div>
              </div>
              <div className="lg:w-96 flex-shrink-0">
                <div className="bg-gradient-to-br from-[var(--primary)] to-[#1a2d5e] rounded-2xl p-8 text-white shadow-2xl">
                  ...
                  <p className="text-blue-100 text-sm mb-6">
                    Caterpillar, Volvo, Case, JCB, John Deere e Komatsu
                  </p>
                  <div className="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-3 rounded-xl">
                    ...
                    <span className="font-bold text-sm">Líderes Mundiais do Setor</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-blue-100 max-w-2xl mx-auto mb-10 leading-relaxed">
                Nossa rede de fornecedores é ampla. Consulte disponibilidade para <strong>outras marcas e modelos</strong>.
              </p>
