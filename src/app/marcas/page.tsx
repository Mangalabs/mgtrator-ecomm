...
export const metadata: Metadata = {
  ...
  description: 'Peças genuínas e compatíveis para as principais marcas de maquinas pesadas e máquinas pesadas. Distribuidor autorizado com garantia original e pronta entrega em MG.',
