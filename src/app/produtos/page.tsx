...
export const metadata: Metadata = {
  ...
  description:
    'Encontre peças genuínas e compatíveis para tratores e máquinas pesadas das marcas Caterpillar, Volvo, Case, JCB, John Deere e Komatsu. Entrega rápida e garantia. Mais de 1.500 peças em estoque.',
  keywords: [
    'peças para tratores',
